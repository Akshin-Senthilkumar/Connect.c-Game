...
/*----------------------------------------------------
void AddBoard()
by interacting with slist.c and slist.h, this function
adds the board into the linked list using strcopy 
----------------------------------------------------*/
void AddBoard(LinkedList* moves, char board[][NUM_COLS])
{
    AddToLinkedList(moves, board);
}
...
----------------------------------------------------*/
void PlayConnectFour(LinkedList* moves)
{
...
/*----------------------------------------------------
void ReplayConnectFour()
prints the past moves made by the players in order,
the sleep function to slow the output 
----------------------------------------------------*/
int ReplayConnectFour(LinkedList* moves)
{
    printf("\n");
    PrintLinkedList(moves);
    return 0;
}
...
while (!done)
    {
        ...
        {
            FreeLinkedList(&moves);
            PlayConnectFour(&moves);
            printf("Press 'q' to quit, 'r' to replay the game or any other key to continue:\n");
            scanf(" %c", &c);
            if (c == 'r')
            {
